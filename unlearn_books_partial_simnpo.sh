...
TARGET_DIR="/home/ae20/muse_data/llama2-sft-7b-books"
...
LR='1e-5'
# LR='1e-3'
PER_DEVICE_BATCH_SIZE=6  # Reduced from 8 to 2, with gradient_accumulation_steps=4 effective batch is 2*4*4=32
FT_EPOCHS=1
FT_LR='1e-5'
GRAD_STEPS=2
SEED=1
